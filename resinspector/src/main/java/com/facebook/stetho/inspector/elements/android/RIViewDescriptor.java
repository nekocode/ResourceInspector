 ...
 */
final class RIViewDescriptor extends AbstractChainedDescriptor<View>
    ...
    public RIViewDescriptor() {
        this(new MethodInvoker());
    }

    public RIViewDescriptor(MethodInvoker methodInvoker) {
    ...
    protected void onGetAttributes(View element, AttributeAccumulator attributes) {
        final String resName = ResourceInspector.getViewLayoutResName(element);
        if (!TextUtils.isEmpty(resName)) {
            attributes.store(RES_NAME, resName + ".xml");
        }
    }
