 ...
 */
final class RIViewGroupDescriptor extends AbstractChainedDescriptor<ViewGroup>
    ...
    private boolean isChildVisible(View child) {
        return !(child instanceof DocumentHiddenView) && child.getVisibility() == View.VISIBLE;
    }
